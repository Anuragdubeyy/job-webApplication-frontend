...
export default function LeftSideBar({ isSideBarOpen, toggleSideBar }: Props) {
  ...
  return (
    <aside
      className={`sticky left-0 top-0 z-20 flex h-screen min-w-fit bg-teal-800 w-10 flex-col justify-between  border-r pt-3 pb-5 pr-1 ${
